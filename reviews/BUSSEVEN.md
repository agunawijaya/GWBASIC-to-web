# BUSSEVEN.BAS — Business Simulation, bagian 7

> Berantai ke BUSEIGHT.
...
| Subrutin | 8, dipanggil dari 12 tempat |
| Percabangan | 1 `GOTO`, 12 `GOSUB`, 2 target `ON…` |
| Komentar | 0% dari baris |
| Jalankan | `run\BUSSEVEN.bat` |
...
flowchart TD
    ...
    S190["':FOR I 1 TO 10:JA JA+'<br/>190..660 (48 baris)"]
    S670["gambar ulang layar<br/>670..750 (9 baris)"]
    S760["locate+print+for 760<br/>760..880 (13 baris)"]
    S890["locate+print+color 890<br/>890..950 (7 baris)"]
    S960["locate+print+color 960<br/>960..1010 (6 baris)"]
    S1020[/"blok 1020<br/>1020..1020"/]
    MAIN --> S1020
    MAIN --> S70
    MAIN --> S670
    MAIN --> S760
...
|---|--:|--:|---|
| `40`–`70` | 4 baris | 3× | buang penyangga tombol |
| `670`–`750` | 9 baris | 3× | gambar ulang layar |
| `70`–`70` | 1 baris | 1× | blok @70 |
| `190`–`660` | 48 baris | 1× | ":FOR I=1 TO 10:JA=JA+" |
| `760`–`880` | 13 baris | 1× | locate+print+for @760 |
| `890`–`950` | 7 baris | 1× | locate+print+color @890 |
| `960`–`1010` | 6 baris | 1× | locate+print+color @960 |
...
flowchart LR
    SELF["BUSSEVEN"]
    SELF -->|"RUN<br/>(variabel hilang)"| NBUSEIGHT["BUSEIGHT"]
...
Bagian ketujuh dari rangkaian sepuluh bagian. Arsitektur seluruh rangkaian identik,
...
gambar halaman, tunggu tombol*, lalu `RUN "BUSEIGHT"`.
...
Materinya jurnal penutup.

Penjelasan lengkap soal teknik overlay ada di [BUSONE.md](BUSONE.md).

## Yang menarik dari kodenya

Bagian ketujuh dari tutorial sepuluh bagian Friendlyware. Kerangkanya (jebakan F1–F9, `POKE 106,0` untuk membuang tombol menumpuk, rutin tunggu-tombol di baris 40–70) identik dengan berkas lainnya — penjelasan lengkapnya ada di [BUSONE.md](BUSONE.md).

Materinya jurnal penutup (closing entries).
