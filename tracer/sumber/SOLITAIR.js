/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/SOLITAIR.BAS (313 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["SOLITAIR"] = [
  "10 REM $LINESIZE:132",
  "20 REM ----------------------------------------------------------------------",
  "30 REM",
  ...
  "340 IF FLAG=1 AND WON THEN 230 ELSE IF FLAG=1 THEN CLS:PRINT PARDON$:GOTO 250 ELSE COLOR 7,0,0:CLS:LOAD\"MENU\",R",
  "350 Z = 2",
  "360 FOR I=1 TO 52",
  ...
  "2250 LOCATE 24,24:PRINT\"Would you like to see the cards? \"; :SOUND 1975,0.5:GOSUB 2720 : SOUND 1975,0.5",
