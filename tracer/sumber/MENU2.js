/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/MENU2.BAS (642 baris) */
...
window.SUMBER["MENU2"] = [
  ...
  "150 LOCATE 12,1:COLOR 0,7:PRINT\" B \";:COLOR 3,0:PRINT\" Depreciation Costs\"",
  "160 LOCATE 15,1:COLOR 0,7:PRINT\" C \";:COLOR 3,0:PRINT\" Inventory Reorder\"",
  "170 LOCATE 9,27:COLOR 0,7:PRINT\" D \";:COLOR 3,0:PRINT\" Present / Future Value\"",
  "180 LOCATE 12,27:COLOR 0,7:PRINT\" E \";:COLOR 3,0:PRINT\" Amortization Analysis\"",
  "190 LOCATE 15,27:COLOR 0,7:PRINT\" F \";:COLOR 3,0:PRINT\" Economic Order Quantity\"",
  "191 LOCATE 18,27:COLOR 0,7:PRINT\" G \";:COLOR 3,0:PRINT\" Introduction to Computers\"",
  "200 LOCATE 9,57:COLOR 0,7:PRINT\" H \";:COLOR 3,0:PRINT\" Break Even Analysis\"",
  "210 LOCATE 12,57:COLOR 0,7:PRINT\" I \";:COLOR 3,0:PRINT\" Stock Ratio Analysis\"",
  "220 LOCATE 15,57:COLOR 0,7:PRINT\" J \";:COLOR 3,0:PRINT\" Check Book Register\"",
  "221 LOCATE 18,57:COLOR 0,7:PRINT\" K \";:COLOR 3,0:PRINT\" Return to Menu #1\"",
  "230 LOCATE 22,13:COLOR 15,0:PRINT\"*****\";:COLOR 3:PRINT\" Strike Key Corresponding To Function Desired \";:COLOR 15:PRINT\"*****\":COLOR 3",
  "290 POKE 106,0",
  "300 RS$=INKEY$:IF RS$=\"\" THEN 300",
  "310 IF RS$=\"A\" OR RS$=\"a\" THEN RUN\"BUSONE\"",
  "320 IF RS$=\"B\" OR RS$=\"b\" THEN 1940",
  "330 IF RS$=\"E\" OR RS$=\"e\" THEN 450",
  "340 IF RS$=\"H\" OR RS$=\"h\" THEN 1560",
  "350 IF RS$=\"C\" OR RS$=\"c\" THEN 4770",
  "360 IF RS$=\"F\" OR RS$=\"f\" THEN 3060",
  "370 IF RS$=\"D\" OR RS$=\"d\" THEN 3480",
  "380 IF RS$=\"i\" OR RS$=\"I\" THEN 5120",
  "385 IF RS$=\"g\" OR RS$=\"G\" THEN RUN\"INTRO\"",
  "390 IF RS$=\"J\" OR RS$=\"j\" THEN RUN\"CHECK\"",
  "395 IF RS$=\"K\" OR RS$=\"k\" THEN RUN\"MENU\"",
  "400 GOTO 300",
  "410 IF ERR=53 THEN RUN\"menu2",
  ...
  "1170 IF ABS(ABS(I#)-1E-10)<5E-10 GOTO 1250",
  ...
  "1600 LOCATE 1,19:PRINT\"\u250c\":LOCATE 1,63:PRINT\"\u2510\":LOCATE 3,63:PRINT\"\u2518\":LOCATE 3,19:PRINT\"\u2514\"",
  "1610 LOCATE 2,19:PRINT\"\u2502\"SPC(43)\"\u2502\":COLOR 0,7",
  "1620 LOCATE 2,31:PRINT\" B R E A K   E V E N \":COLOR 7,0",
  "1630 COLOR 11,0:LOCATE 4,32:PRINT\"Break Even Analysis\":COLOR 7,0",
  "1640 LOCATE 5,6:PRINT\"\u2554\";:FOR I=1 TO 68:PRINT\"\u2550\";:NEXT:PRINT\"\u2557\"",
  "1650 FOR J=6 TO 23:LOCATE J,75:PRINT\"\u2551\":NEXT:LOCATE ,75:PRINT\"\u255d\";",
  "1660 FOR J=74 TO 7 STEP-1:LOCATE 24,J:PRINT\"\u2550\";:NEXT:LOCATE 24,6:PRINT\"\u255a\";",
  "1670 FOR J=23 TO 6 STEP-1:LOCATE J,6:PRINT \"\u2551\":NEXT:RETURN",
  "1680 COLOR 11,0:LOCATE 25,17:PRINT\"***** Strike Any Key For Additional Analysis *****\";:COLOR 7,0:RETURN",
  "1690 LOCATE 7,18,0:PRINT\"Fixed Costs (In $)\"",
  "1700 LOCATE 9,18:PRINT\"Variable Costs (In %)\"",
  "1710 LOCATE 7,18,1:COLOR 11,0:PRINT\"Fixed Costs (In $)            \";",
  "1720 GOSUB 1930:FCOST#=VAL(ZA):IF FCOST#=0 THEN 1710",
  "1730 LOCATE 9,18,1:PRINT\"Variable Costs (In %)         \";",
  "1740 DEC=3:GOSUB 1930:VPERC#=VAL(ZA)",
  "1750 IF VPERC#=0 OR VPERC#>99 THEN LOCATE 23,20,0:PRINT\"Percent cannot be greater than 100 - Retry\":FOR I=1 TO 2500:NEXT:LOCATE 23,19:PRINT SPACE$(43):LOCATE 9,40:PRINT SPACE$(30):GOTO 1730",
  "1760 LOCATE 7,18,1:PRINT USING\"Fixed Costs (In $)            $$##########,.##\";FCOST#",
  "1770 LOCATE 9,18,1:PRINT USING\"Variable Costs (In %)                  ##,.##%\";VPERC#",
  "1780 LOCATE 11,15,0:PRINT\"Sales         Fixed Costs    Variable Costs      Net Profit\"",
  "1790 FPERC#=(100-VPERC#)/100",
  "1800 VCOST#=INT(((FCOST#*VPERC#/FPERC#/100)+0.005000001)*100)/100",
  "1810 SALES#=VCOST#+FCOST#",
  "1820 COLOR 7,0:PC#=0.75",
  "1830 FOR I=13 TO 23",
  "1840 ESALES#=INT(((SALES#*PC#)+0.005000001)*100)/100",
  "1850 ECOST#=INT(((ESALES#*VPERC#/100)+0.005000001)*100)/100",
  "1860 EPROFIT#=ESALES#-FCOST#-ECOST#",
  "1870 IF PC#=1 THEN COLOR 11,0:EPROFIT#=0",
  "1880 LOCATE I,7:PRINT USING\"$$##########,.## $$##########,.## $$##########,.## $$##########,.##\";ESALES#;FCOST#;ECOST#;EPROFIT#;",
  "1890 COLOR 7,0",
  "1900 PC#=INT((PC#+0.05500001)*100)/100",
  "1910 NEXT",
  "1920 RETURN",
  "1930 GOTO 6040",
  "1940 GOTO 1950",
  "1950 GOSUB 2090:GOSUB 2140",
  "1960 GOSUB 460",
  "1970 IF (RS$<\"a\" OR RS$>\"e\") AND (RS$<\"A\" OR RS$>\"E\") THEN 1960",
  "1980 IF RS$=\"E\" OR RS$=\"e\" THEN 40",
  "1990 SAVERS$=RS$",
  "2000 GOSUB 2090",
  "2010 IF RS$=\"A\" OR RS$=\"a\" THEN HD$=\"      Straight-line method\":GOTO 2050",
  "2020 IF RS$=\"B\" OR RS$=\"b\" THEN HD$=\"   Units-of-production method\":GOTO 2060",
  "2030 IF RS$=\"C\" OR RS$=\"c\" THEN HD$=\"    Declining-balance method\":GOTO 2070",
  "2040 IF RS$=\"D\" OR RS$=\"d\" THEN HD$=\" Sum-of-the-years-digits method\":GOTO 2080",
  "2050 GOSUB 2230:GOSUB 2280:GOSUB 2390:GOSUB 2450:GOSUB 2550:GOSUB 2580:GOSUB 2620:GOSUB 2660:GOSUB 2220:GOSUB 460:GOTO 1950",
  "2060 GOSUB 2230:GOSUB 2330:GOSUB 2390:GOSUB 2960:GOSUB 2580:GOSUB 3010:GOSUB 2220:GOSUB 460:GOTO 1950",
  "2070 GOSUB 2230:GOSUB 2280:GOSUB 2390:GOSUB 2450:GOSUB 2580:GOSUB 2620:GOSUB 2730:GOSUB 2220:GOSUB 460:GOTO 1950",
  "2080 GOSUB 2230:GOSUB 2280:GOSUB 2390:GOSUB 2450:GOSUB 2580:GOSUB 2620:GOSUB 2860:GOSUB 2220:GOSUB 460:GOTO 1950",
  "2090 CLS:PRINT:COLOR 0,7:PRINT\" F10 \";:COLOR 7,0:PRINT\" To Menu\":COLOR 11,0",
  "2100 FOR I=1 TO 3 STEP 2:FOR J=20 TO 62:LOCATE I,J,0:PRINT\"\u2500\":NEXT:NEXT",
  "2110 LOCATE 1,19:PRINT\"\u250c\":LOCATE 1,63:PRINT\"\u2510\":LOCATE 3,63:PRINT\"\u2518\":LOCATE 3,19:PRINT \"\u2514\"",
  "2120 LOCATE 2,19:PRINT\"\u2502\"SPC(43)\"\u2502\"",
  "2130 COLOR 0,7:LOCATE 2,29:PRINT\" D E P R E C I A T I O N \":COLOR 7,0:RETURN",
  "2140 COLOR 11,0:LOCATE 5,32:PRINT\"FUNCTIONS AVAILABLE\"",
  "2150 PRINT;TAB(32);\"-------------------\"",
  "2160 LOCATE 8,25:COLOR 0,7:PRINT\" A \";:COLOR 7,0:PRINT\" Straight-line method\"",
  "2170 LOCATE 10,25:COLOR 0,7:PRINT\" B \";:COLOR 7,0:PRINT\" Units-of-production method\"",
  "2180 LOCATE 12,25:COLOR 0,7:PRINT\" C \";:COLOR 7,0:PRINT\" Double-Declining-balance method\"",
  "2190 LOCATE 14,25:COLOR 0,7:PRINT\" D \";:COLOR 7,0:PRINT\" Sum-of-the-years-digits method\"",
  "2200 LOCATE 16,25:COLOR 0,7:PRINT\" E \";:COLOR 7,0:PRINT\" Return to main menu\"",
  "2210 COLOR 11,0:LOCATE 23,12:PRINT\"***** Strike Key Corresponding To Function Desired *****\":COLOR 7,0:RETURN",
  "2220 LOCATE 25,22:PRINT\"***** Strike Key To Return To Menu *****\";:COLOR 7,0:RETURN",
  "2230 COLOR 11,0:LOCATE 4,25:PRINT HD$:COLOR 7,0",
  "2240 LOCATE 5,4:PRINT\"\u2554\";:FOR I=1 TO 72:PRINT\"\u2550\";:NEXT:PRINT\"\u2557\"",
  "2250 FOR J=6 TO 23:LOCATE J,77:PRINT\"\u2551\":NEXT:LOCATE ,77:PRINT\"\u255d\";",
  "2260 FOR J=76 TO 5 STEP -1:LOCATE 24,J:PRINT\"\u2550\";:NEXT:LOCATE 24,4:PRINT\"\u255a\";",
  "2270 FOR J=23 TO 6 STEP -1:LOCATE J,4:PRINT\"\u2551\":NEXT:RETURN",
  "2280 LOCATE 7,16,0:PRINT\"Asset Cost\"",
  "2290 LOCATE 9,16:PRINT\"Estimated Residual Value\"",
  "2300 LOCATE 11,16:PRINT\"Estimated Life (20 Yrs Max)\"",
  "2310 LOCATE 13,16:PRINT\"Fiscal Year Starting Month (1-12)\"",
  "2320 LOCATE 15,16:PRINT\"Usage Year Starting Month (1-12)\":RETURN",
  "2330 LOCATE 7,16,0:PRINT\"Asset Cost\"",
  "2340 LOCATE 9,16:PRINT\"Estimated Residual Value\"",
  "2350 LOCATE 11,16:PRINT\"Estimated Life (Hours)\"",
  "2360 LOCATE 13,16:PRINT\"Hours Used During Year\"",
  "2370 LOCATE 15,16:PRINT\"Hourly Depreciation Rate\"",
  "2380 LOCATE 17,16:PRINT\"Current Year Depreciation\":RETURN",
  "2390 LOCATE 7,16,1:COLOR 11,0:PRINT\"Asset Cost                        \";",
  "2400 GOSUB 3050:COST#=VAL(ZA):IF COST#=0 THEN 2390",
  "2410 LOCATE 9,16:COLOR 11,0:PRINT\"Estimated Residual Value          \";",
  "2420 GOSUB 3050:VALUE#=VAL(ZA)",
  ...
  "2440 RETURN",
  "2450 LOCATE 11,16:COLOR 11,0:PRINT\"Estimated Life (20 Yrs Max)       \";",
  "2460 GOSUB 6350:LF#=VAL(ZA):IF LF#=0 THEN 2450",
  "2470 IF LF#>20 THEN LOCATE 23,17:COLOR 11,0:PRINT\"Estimated life cannot be greater than 20 - Retry\":FOR I=1 TO 2500:NEXT:LOCATE 23,17:PRINT SPC(49):LOCATE 11,45:PRINT SPC(20):COLOR 7,0:GOTO 2450",
  "2480 IF LF#<3 THEN LOCATE 23,17:COLOR 11,0:PRINT\"This method not advisable for short term - Retry\":FOR I=1 TO 2500:NEXT:LOCATE 23,17:PRINT SPC(50):LOCATE 11,45:PRINT SPC(20):COLOR 7,0:GOTO 2450",
  "2490 LOCATE 13,16:COLOR 11,0:PRINT\"Fiscal Year Starting Month (1-12) \";",
  "2500 GOSUB 6350:FMNT#=VAL(ZA):IF FMNT#=0 THEN 2490",
  "2510 LOCATE 15,16:COLOR 11,0:PRINT\"Usage Year Starting Month  (1-12) \";",
  "2520 GOSUB 6350:UNMT#=VAL(ZA):IF UNMT#=0 THEN 2510 ELSE NMNT#=UNMT#",
  "2530 IF UNMT#<FMNT# THEN NMNT#=UNMT#+12",
  "2540 PARTIAL#=12-(NMNT#-FMNT#):RETURN",
  "2550 AN#=(COST#-VALUE#)/LF#",
  "2560 IF PARTIAL#<12 THEN FIRST#=AN#*PARTIAL#/12:LAST#=AN#*(12-PARTIAL#)/12:REMAIN#=12-PARTIAL#:YS#=LF#-1",
  "2570 RETURN",
  "2580 COLOR 11,0",
  "2590 LOCATE 7,16:PRINT USING\"Asset Cost                    $$##############,.##\";COST#",
  "2600 LOCATE 9,16:PRINT USING\"Estimated Residual Value      $$##############,.##\";VALUE#",
  "2610 RETURN",
  "2620 LOCATE 11,16:PRINT USING\"Estimated Life (20 Yrs Max)                   ####\";LF#",
  "2630 LOCATE 13,16:PRINT USING\"Fiscal Year Starting Month (1-12)               ##\";FMNT#",
  "2640 LOCATE 15,16:PRINT USING\"Usage Year Starting Month (1-12)                ##\";UNMT#",
  "2650 RETURN",
  "2660 IF PARTIAL#<12 GOTO 2690",
  "2670 LOCATE 17,16:PRINT USING\"Annual Depreciation           $$##############,.##\";AN#",
  "2680 GOTO 2720",
  "2690 LOCATE 17,16:PRINT\"First \" PARTIAL# \" Months Deprec.\";TAB(46);:PRINT USING \"$$##############,.##\";FIRST#",
  "2700 LOCATE 19,16:PRINT\"Annual Deprec.: \" YS# \" Years\";TAB(46);:PRINT USING \"$$##############,.##\";AN#",
  "2710 LOCATE 21,16,1:PRINT\"Last  \" REMAIN# \" Months Deprec.\";TAB(46);:PRINT USING \"$$##############,.##\";LAST#",
  "2720 RETURN",
  "2730 LOCATE 17,6,0:PRINT\"Yr.      Deprec.  Yr.      Deprec.  Yr.      Deprec.  Yr.      Deprec.\"",
  "2740 LOCATE 18,6:PRINT\"---  -----------  ---  -----------  ---  -----------  ---  -----------\"",
  "2750 PC#=INT((100/LF#*0.02+0.005000001)*100)/100",
  "2760 BK#=COST#",
  "2770 AN#=INT((PARTIAL#/12*(PC#*BK#)+0.005000001)*100)/100",
  "2780 BK#=BK#-AN#:YRS#=1",
  "2790 FOR C= 6 TO 65 STEP 18:FOR R=19 TO 23",
  "2800 LOCATE R,C,0:PRINT USING\"## \";YRS#;:COLOR 7,0:PRINT USING\"$$#######,.##\";AN#:COLOR 11,0",
  "2810 YRS#=YRS#+1:IF YRS#>LF# THEN 2850",
  "2820 AN#=INT((PC#*BK#+0.005000001)*100)/100:BK#=BK#-AN#",
  "2830 IF BK#<VALUE# AND BK#>0 THEN BK#=BK#+AN#:AN#=INT((BK#-VALUE#+0.005000001)*100)/100:BK#=0",
  "2840 NEXT:NEXT",
  "2850 RETURN",
  "2860 LOCATE 17,6,0:PRINT\"Yr.      Deprec.  Yr.      Deprec.  Yr.      Deprec.  Yr.      Deprec.\"",
  "2870 LOCATE 18,6:PRINT\"---  -----------  ---  -----------  ---  -----------  ---  -----------\"",
  "2880 DENOM#=0:FOR I=1 TO LF#:DENOM#=DENOM#+I:NEXT:BK#=COST#-VALUE#:YRS#=1",
  "2890 AN#=INT((PARTIAL#/12*(LF#/DENOM#*BK#)+0.005000001)*100)/100",
  "2900 FOR C= 6 TO 65 STEP 18:FOR R=19 TO 23",
  "2910 LOCATE R,C,0:PRINT USING\"## \";YRS#;:COLOR 7,0:PRINT USING\"$$#######,.##\";AN#:COLOR 11,0",
  "2920 AN#=INT((((12-PARTIAL#)/12*((LF#-YRS#+1)/DENOM#*BK#))+((12-(12-PARTIAL#))/12*((LF#-YRS#)/DENOM#*BK#))+0.005000001)*100)/100",
  "2930 YRS#=YRS#+1:IF YRS#>LF# THEN 2950",
  "2940 NEXT:NEXT",
  "2950 RETURN",
  "2960 LOCATE 11,16:COLOR 11,0:PRINT\"Estimated Life (Hours)            \";",
  "2970 GOSUB 6350:LF#=VAL(ZA):IF LF#=0 THEN 2960",
  "2980 LOCATE 13,16:COLOR 11,0:PRINT\"Hours Used During Year            \";",
  "2990 GOSUB 6350:HRS#=VAL(ZA):IF HRS#=0 THEN 2980",
  "3000 HR#=(COST#-VALUE#)/LF#:AN#=HR#*HRS#:RETURN",
  "3010 LOCATE 11,16,1:PRINT USING\"Estimated Life (Hours)                     #######\";LF#",
  "3020 LOCATE 13,16,1:PRINT USING\"Hours Used During Year                     #######\";HRS#",
  "3030 LOCATE 15,16,1:PRINT USING\"Hourly Depreciation Rate          $$##########,.##\";HR#",
  "3040 LOCATE 17,16,1:PRINT USING \"Current Year Depreciation     $$##############,.##\";AN#:RETURN",
  "3050 GOTO 6040",
  "3060 GOTO 3070",
  "3070 GOSUB 3080:GOSUB 3200:GOSUB 3190:GOSUB 460:GOTO 3070",
  "3080 CLS:PRINT:COLOR 0,7:PRINT\" F10 \";:COLOR 7,0:PRINT\" To Menu\":COLOR 11,0",
  "3090 FOR I=1 TO 3 STEP 2:FOR J=20 TO 62:LOCATE I,J,0:PRINT\"\u2500\":NEXT:NEXT",
  "3100 LOCATE 1,19:PRINT\"\u250c\":LOCATE 1,63:PRINT\"\u2510\":LOCATE 3,63:PRINT\"\u2518\":LOCATE 3,19:PRINT\"\u2514\"",
  "3110 LOCATE 2,19:PRINT\"\u2502\" SPC(43) \"\u2502\":COLOR 0,7",
  "3120 LOCATE 2,27:PRINT\" E C O N O M I C   O R D E R \":COLOR 7,0",
  "3130 COLOR 11,0:LOCATE 4,30:PRINT\"Economic Order Quantity\":COLOR 7,0",
  "3140 LOCATE 5,11:PRINT\"\u2554\";:FOR I=1 TO 58:PRINT\"\u2550\";:NEXT:PRINT\"\u2557\"",
  "3150 FOR J=6 TO 23:LOCATE J,70:PRINT\"\u2551\":NEXT:LOCATE ,70:PRINT\"\u255d\";",
  "3160 FOR J=69 TO 12 STEP -1:LOCATE 24,J:PRINT\"\u2550\";:NEXT:LOCATE 24,11:PRINT\"\u255a\";",
  "3170 FOR J=23 TO 6 STEP -1:LOCATE J,11:PRINT\"\u2551\":NEXT",
  "3180 RETURN",
  "3190 COLOR 11,0:LOCATE 25,17,0:PRINT\"***** Strike Any Key For Additional Analysis *****\";:COLOR 7,0:RETURN",
  "3200 LOCATE 7,18,0:PRINT\"Units Required During Year\"",
  "3210 LOCATE 9,18:PRINT\"Ordering Cost, Per Order\"",
  "3220 LOCATE 11,18:PRINT\"Holding Cost, Per Unit\"",
  "3230 LOCATE 13,18:PRINT\"Economic Order Quantity\"",
  "3240 LOCATE 15,18:PRINT\"Number of Orders Per Year\"",
  "3250 LOCATE 17,18:PRINT\"Average Units In Inventory\"",
  "3260 LOCATE 19,18:PRINT\"Total Ordering Cost\"",
  "3270 LOCATE 21,18:PRINT\"Total Holding Cost\"",
  "3280 COLOR 11,0:LOCATE 7,18,1:PRINT\"Units Required During Year    \";",
  "3290 GOSUB 6350:UNITS#=VAL(ZA):IF UNITS#=0 THEN 3280",
  "3300 LOCATE 9,18,1:PRINT\"Ordering Cost, Per Order      \";",
  "3310 GOSUB 3470:COST#=VAL(ZA):IF COST#=0 THEN 3300",
  "3320 LOCATE 11,18,1:PRINT\"Holding Cost, Per Unit        \";",
  "3330 GOSUB 3470:HOLD#=VAL(ZA):IF HOLD#=0 THEN 3320",
  "3340 EOQ#=INT(SQR(2*UNITS#*COST#/HOLD#)+0.5)",
  "3350 ODS#=INT((UNITS#/EOQ#)+0.5):IF (ODS#*EOQ#)<UNITS# THEN ODS#=ODS#+1",
  "3360 AVERAGE#=INT(EOQ#/2+0.5)",
  "3370 TOTCOST#=INT((COST#*ODS#+0.005000001)*100)/100",
  "3380 TOTHOLD#=INT((AVERAGE#*HOLD#+0.005000001)*100)/100",
  "3390 LOCATE 7,18,0:PRINT USING\"Units Required During Year      ###########,##\";UNITS#",
  "3400 LOCATE 9,18:PRINT USING\"Ordering Cost, Per Order      $$##########,.##\";COST#",
  "3410 LOCATE 11,18:PRINT USING\"Holding Cost, Per Unit        $$##########,.##\";HOLD#",
  "3420 LOCATE 13,18:PRINT USING\"Economic Order Quantity          ##########,##\";EOQ#",
  "3430 LOCATE 15,18:PRINT USING\"Number of Orders Per Year        ##########,##\";ODS#",
  "3440 LOCATE 17,18:PRINT USING\"Average Units In Inventory       ##########,##\";AVERAGE#",
  "3450 LOCATE 19,18:PRINT USING\"Total Ordering Cost           $$##########,.##\";TOTCOST#",
  "3460 LOCATE 21,18:PRINT USING\"Total Holding Cost            $$##########,.##\";TOTHOLD#:RETURN",
  "3470 GOTO 6040",
  "3480 GOTO 3490",
  ...
  "3630 CLS:PRINT:COLOR 0,7:PRINT\" F10 \";:COLOR 7,0:PRINT\" To Menu\":COLOR 11,0",
