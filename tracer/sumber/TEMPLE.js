/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/TEMPLE.BAS (1187 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["TEMPLE"] = [
  "10 KEY OFF",
  ...
  "4110  PRINT \"\u2551 D = stairs down     \u2229 = entrance/exit   \u0192 = flares           \u2551\"",
  "4120  PRINT \"\u2551 G = gold pieces     \u00a5 = monster         \u03a6 = crystal orb      \u2551\"",
  ...
  "4550 FOR Y=1 TO 8",
  "4560 Q=L(FND(Z))",
  "4570 IF Q > 99 THEN Q=Q-100:LET Q=34:REM TO HIDE ROOMS",
  ...
  "5500 BL=1",
  "5510 GOTO 5650",
  "5520 PRINT \"It's another volume of Nur\u00facc's poetry! - YECH!!\"",
  "5530 GOTO 5650",
  ...
  "8500 PRINT",
  "8510 COLOR 11,0,15:BEEP:PRINT \"You've found the Runestaff!\";CHR$(7):COLOR 3,0,12",
  "8515 FTRS=10000",
  "8520 R(1)=0",
  "8530 RF=1",
  "8540 Q=FNA(1000)",
  ...
  "10180 GOTO 11040",
  "10190 PRINT",
  "10200 'PRINT \"Great unmitigated Nur\u00facc!\"",
  "10210 PRINT",
  ...
  "10350 DATA flares,\u0192,a warp,\u2588,a sinkhole,S,a Crystal Orb,\u03a6",
  ...
  "10380 DATA a Balor Demon,\u00a5,a Red Dragon,\u03b4,a Drow Merchant,\u03a9,the Ruby Red,T",
  ...
  "11080 PRINT",
  "11090 GOTO 3690",
  "11100 LPRINT \"*** TEMPLE OF LOTH'S COMMAND AND INFORMATION SUMMARY ***\"",
  "11110 LPRINT",
  "11120 LPRINT \"The following commands available are:\"",
  "11130 LPRINT",
  "11140 LPRINT \"H=Help   N=North    S=South   E=East    W=West    U=Up\"",
  "11150 LPRINT \"D=Down   DR=Drink   M=Map     F=Flare   L=Lamp    O=Open\"",
  "11160 LPRINT \"G=Gaze   T=Teleport Q=Quit    #=Score",
  "11170 LPRINT",
  "11180 LPRINT \"The contents of the rooms are as follows:\"",
  "11190 LPRINT",
  "11200 LPRINT \"\u256c = empty room      B = book            C = chest\"",
  "11210 LPRINT \"D = stairs down     \u2229 = entrance/exit   \u0192 = flares\"",
  "11220 LPRINT \"G = gold pieces     \u00a5 = monster         \u03a6 = crystal orb\"",
  "11230 LPRINT \"P = magic pool      S = sinkhole        T = treasure\"",
  "11240 LPRINT \"U = stairs up       * = Drow            \u2588 = warp/amulet",
  "11250 LPRINT",
  "11260 LPRINT",
  "11270 LPRINT \"The benefits of having treasures are:\"",
  "11280 LPRINT",
  "11290 LPRINT \"RUBY RED - avoid lethargy    PALE PEARL - avoid leech\"",
  "11300 LPRINT \"GREEN GEM - avoid forgetting  OPAL EYE - cure blindness\"",
  "11310 LPRINT \"BLUE FLAME - dissolves books  NORN STONE - no benefit\"",
  "11320 LPRINT \"PALANTIR - no benefit         SILMARIL - no benefit\"",
  "11330 LPRINT",
  "11340 GOTO 3700",
  "11350 END",
  "11360 RF=1",
