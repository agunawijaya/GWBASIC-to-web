/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/STATS.BAS (449 baris) */
...
window.SUMBER["STATS"] = [
  ...
  "270 COLOR 3,0:CLS:LOCATE 1,20:PRINT STRING$(41,\"\u2588\")",
  "280 LOCATE 2,20:PRINT\"\u2588\u2588\"TAB(35)\"SPORTS MENU\";:LOCATE ,59:PRINT\"\u2588\u2588\"",
  "290 LOCATE 3,20:PRINT STRING$(41,\"\u2588\")",
  "300 FOR A=4 TO 12:LOCATE A,20:PRINT\"\u2588\u2588\":LOCATE A,59:PRINT\"\u2588\u2588\":NEXT",
  "310 LOCATE 13,20:PRINT STRING$(41,\"\u2588\")",
  ...
  "1770 RETURN",
  "1780 CLS:PRINT STRING$(80,\"\u2588\")",
  "1790 FOR A=2 TO 22:LOCATE A,1:PRINT\"\u2588\":LOCATE A,80:PRINT\"\u2588\":NEXT",
  "1800 LOCATE 23,1:PRINT STRING$(80,\"\u2588\");",
