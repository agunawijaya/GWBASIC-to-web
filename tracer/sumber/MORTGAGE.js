/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/MORTGAGE.BAS (204 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["MORTGAGE"] = [
  ...
  "1870 PRINT USING \"##.##\";INT(((R+(I*RINC))*120000)+0.5)/100",
  "1880 NEXT I",
  "1890 COLOR 15,0",
  "1900 FOR I = 0 TO 14",
  "1910 RF = R+I*RINC:AF=1:GOSUB 1480",
  "1920 FOR J = 0 TO COLS",
  "1930 P = PF*(A+J*AINC):P = INT((P+0.005000001)*100)/100",
  ...
  "2410 GOSUB 1480",
  "2420 PF = INT((PF+0.005000001)*100)/100",
