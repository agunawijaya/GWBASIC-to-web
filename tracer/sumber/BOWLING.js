/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/BOWLING.BAS (75 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["BOWLING"] = [
  ...
  "210 FOR I=0 TO A-1:S(I)=1:NEXT",
  "230 FOR Q=1 TO 10:FOR Z9=0 TO A-1",
  ...
  "290 A$=\"\":WHILE+ A$=\"\":A$=INKEY$:WEND:IF A$=\"Y\"THEN RUN ELSE COLOR 7,0:LOAD\"MENU\",R",
  "310 LOCATE 20,1:PRINT \"Take two more balls, \";NA$(Z9);",
  "320 FOR I=1 TO 2000:NEXT :LOCATE ,1:PRINT SPC(29)",
  "330 S(Z9)=S-1:B1=1:GOSUB 390:IF J<>10 THEN 370 ELSE 360",
  "340 LOCATE 20,1:PRINT \"Take one more ball, \";NA$(Z9);",
  "350 FOR I=1 TO 2200:NEXT :LOCATE ,1:PRINT SPC(28)",
  ...
  "530 FOR I=1 TO DIFLVL:NEXT :IF V=24 OR V=16 THEN D=-D",
