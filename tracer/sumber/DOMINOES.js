/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/DOMINOES.BAS (387 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["DOMINOES"] = [
  ...
  "130 LOCATE 4,1:FOR A=1 TO CONO:PRINT \"\u2584\u2584\":NEXT:GOSUB 3800:GOTO 50",
  ...
  "2040 RETURN",
  "2050 LOCATE 25,1:PRINT SPC(79);:LOCATE 25,20",
  ...
  "2100 NEXT",
  "2110 LOCATE 25,1:PRINT SPC(79);:RETURN",
  ...
  "2560 COLOR 6,0:LOCATE SLN+0,HS:PRINT \"\u250c\u2500\u2500\u2500\u2510\"",
  "2570 LOCATE SLN+1,HS:PRINT \"\u2502   \u2502\"",
  "2580 LOCATE SLN+2,HS:PRINT \"\u251c\u2500\u2500\u2500\u2524\"",
  "2590 LOCATE SLN+3,HS:PRINT \"\u2502   \u2502\"",
  "2600 LOCATE SLN+4,HS:PRINT \"\u2514\u2500\u2500\u2500\u2518\":COLOR 15,0",
  "2610 LOCATE SLN+1,HS+1:PRINT DT$(BOT)",
  "2620 LOCATE SLN+3,HS+1:PRINT DT$(TOP):COLOR 7,0:RETURN",
  "2630 COLOR 6,0:LOCATE SLN+0,HS:PRINT \"\u250c\u2500\u2500\u2500\u252c\u2500\u2500\u2500\u2510\"",
  "2640 LOCATE SLN+1,HS:PRINT \"\u2502   \u2502   \u2502\"",
  "2650 LOCATE SLN+2,HS:PRINT \"\u2514\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2518\":COLOR 15,0",
  ...
  "2740   LOCATE I,1:PRINT SPC(79);",
  "2750 NEXT I",
  "2760 FOR A=1 TO PLNO:COLOR 14,0",
  "2770   LOCATE SLN,HS:  PRINT \"\u250c\u2500\u2500\u2500\u252c\u2500\u2500\u2500\u2510\";",
  "2780   LOCATE SLN+1,HS:PRINT \"\u2502   \u2502   \u2502\";",
  "2790   LOCATE SLN+2,HS:PRINT \"\u2514\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2518\";",
  "2800   HS=HS+10",
  ...
  "3030 FOR A=2 TO 22:LOCATE A,1:PRINT \"\u2588\":LOCATE A,80:PRINT \"\u2588\":NEXT",
  ...
  "3280 KEY(10) OFF:XLIN=CSRLIN:XPOS=POS(0):LOCATE 25,1:PRINT SPC(79);",
  ...
  "3330 LOCATE 25,1:PRINT SPC(79);:LOCATE 25,24:COLOR 0,7",
