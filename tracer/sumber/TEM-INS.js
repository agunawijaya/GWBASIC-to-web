/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/TEM-INS.BAS (290 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["TEM-INS"] = [
  ...
  "950 PRINT",
  "960 PRINT \"   \u2229 = The entrance / exit room",
  "970 PRINT \"   \u256c = An empty room containing nothing",
  ...
  "2550 PRINT",
  "2560 PRINT \"     if you have any ideas to improve this program yourself please do. Upload    your improved version on Wes Meier's RBBS at area code [disunting - UU PDP No. 27/2022].",
  "2570 PRINT \"",
  ...
  "2800 PRINT \"",
  "2810 PRINT \"  The highest score to date is that of Lord Nur\u00facc: 142,498",
  "2820 LOCATE 25,1",
