/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/SERPENT.BAS (64 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["SERPENT"] = [
  ...
  "520 CLS:LOCATE 13,3:PRINT \"press a key to start or ESC to end\":A$=INPUT$(1):IF A$=CHR$(27) THEN CLS:COLOR 7,,0:LOAD\"MENU\",R",
