/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/MAXIT1.BAS (145 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["MAXIT1"] = [
  "1000 '   MAXIT  FROM PET",
  ...
  "1160 PRINT \"Do you want instructions ? \";:KS$=INPUT$(1):PRINT",
  "1170 IF KS$= \"Y\" OR KS$=\"y\" THEN GOSUB 2210",
  "1180 PRINT :PRINT \"1 or 2 players ?\";:KS$=INPUT$(1)",
  ...
  "1250 CLS:LOCATE 2,15:COLOR 3,4:PRINT \" M A X I T \":COLOR 5,8:GOSUB 2360",
  ...
  "2210 LOCATE 1,15:COLOR 3,4:PRINT \" M A X I T \":COLOR 5,8:PRINT",
