/* Dihasilkan oleh tracer/alat/bikin-sumber.py - jangan disunting tangan.
   Sumber: run/DROIDS.BAS (183 baris) */
window.SUMBER = window.SUMBER || {};
window.SUMBER["DROIDS"] = [
  "10 KEY OFF:CLS",
  "20 PRINT\"\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\u2591\"",
  "30 PRINT\"\u2591\u250c\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510\u2591\"",
  "40 PRINT\"\u2591\u2502                                   \u2502\u2591\"",
  ...
  "2221 IF Z=1 AND CT=0 THEN 3000",
  "2222 IF Z=1 AND CT=32 THEN 3000",
  "2223 IF Z=1 AND CT=65 THEN 3000",
  "2224 IF Z=1 AND CT=66 THEN 3000",
  "2225 IF Z=1 AND CT=67 THEN 3000",
  "2226 IF Z=1 AND CT=68 THEN 3000",
  "2227 IF Z>1 AND CT=0 THEN RETURN",
  "2229 IF CT=0 OR CT=32 OR CT=65 OR CT=66 OR CT=67 OR CT=68 THEN RETURN",
  ...
  "2420 IF SAMPLE$=\"YES\" THEN CHAIN \"SAMPLES\",1000 ELSE LOAD\"MENU\",R",
  "2430 GOTO 1030",
  "3000 LOCATE 22,1:PRINT \"            ILLEGAL MOVE             \"",
  "3010 FOR I=1 TO 2000:NEXT",
  "3020 LOCATE 22,1:PRINT BL$",
  "3030 GOTO 1130",
];
